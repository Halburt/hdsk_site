...
import com.houdask.site.gen.dao.GenDataBaseDictDao;
...
public class GenTableService extends BaseServiceImpl<GenTableDao,GenTable> {
	...
	public void save1(GenTable genTable) {
		if (StringUtils.isBlank(genTable.getId())){
			genTable.preInsert();
	...
	@Transactional(readOnly = false)
	public void delete1(GenTable genTable) {
