package com.houdask.site.gen.util;
...
import com.houdask.site.gen.mapper.JaxbMapper;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor():"Halburt");
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
		...
		String fileName = "C://"
				...
				+ FreeMarkers.renderString(tpl.getFileName().trim(), model);
