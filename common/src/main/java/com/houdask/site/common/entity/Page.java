...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
	...
	/**
	 * 默认输出当前分页标签 
	 * <div class="page">${page.mobilePage}</div>
	 */
	public String getMobilePage() {
		...
		if(count > 0 && count > pageSize){
			  sb.append("<div class='fenyetable'>");
		        sb.append("<div class='wrap'>");
		        sb.append(" <div class='fenye'>");
		        sb.append("<ul>");
		        sb.append("<li id='first'  onclick=\""+funcName+"("+first+","+pageSize+",'"+funcParam+"');\" >首页</li>");
		        
		        if (pageNo == first) {// 如果是首页
				//	sb.append("<li id='first'>首页</li>");
				} else {
					sb.append("<li onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\" >  上一页 </li> ");
				}
		        sb.append("  <li class='xifenye' onclick='showPageNum()' id='xifenye'>");
		        sb.append("<a id='xiye'>"+ pageNo +"</a>/<a id='mo'>"+last +"</a>");
		        sb.append(" <div class='xab' id='xab' style='display:none'>");
		        sb.append("<ul id='uljia'>");
		        sb.append("</ul>");
		        sb.append("  </div></li>"); 
		        if (pageNo == last) {
					//sb.append(" <li id='down' onclick='javascript:;'>下一页</a></li>");
				} else {
					sb.append(" <li id='down' onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">下一页   </li>");
				}
		        sb.append(" <li id='last' onclick=\""+funcName+"("+last+","+pageSize+",'"+funcParam+"');\">末页</li>");
		        sb.append("</ul>");
